...
void SpirvShaderTranslator::ExportToMemory(uint8_t export_eM) {
  ...
  // Ported from upstream Xenia-Canary (AE was missing this - memexported
  // HDR float16 values > 65504 became Inf/NaN, producing invalid geometry
  // and texture data in memexport-heavy games like Halo 3).
