...
struct BRANCH_TRUE_I8
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.CbnzFar(i.src1, e.GetLabel(i.src2.value->id));
  }
};
...
struct BRANCH_TRUE_F32
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.fmov(e.w0, i.src1);
    e.CbnzFar(e.w0, e.GetLabel(i.src2.value->id));
  }
};
struct BRANCH_TRUE_F64
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.fmov(e.x0, i.src1);
    e.CbnzFar(e.x0, e.GetLabel(i.src2.value->id));
  }
};
...
struct BRANCH_FALSE_I8
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.CbzFar(i.src1, e.GetLabel(i.src2.value->id));
  }
};
...
struct BRANCH_FALSE_F32
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.fmov(e.w0, i.src1);
    e.CbzFar(e.w0, e.GetLabel(i.src2.value->id));
  }
};
struct BRANCH_FALSE_F64
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.fmov(e.x0, i.src1);
    e.CbzFar(e.x0, e.GetLabel(i.src2.value->id));
  }
};
...
// ============================================================================
// OPCODE_CHECK_PREEMPT  (ported from XenDroid)
// ============================================================================
...
struct RETURN_TRUE_I8
  ...
  static void Emit(A64Emitter& e, const EmitArgType& i) {
    e.CbnzFar(i.src1, e.epilog_label());
  }
};
